...
normalizedPF = PF;%(PF - repmat(minVals, m1, 1)) ./ repmat(maxVals - minVals, m1, 1);
normalizedTruePF = truePF;%(truePF - repmat(minVals, m, 1)) ./ repmat(maxVals - minVals, m, 1);
