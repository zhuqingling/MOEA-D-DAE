...
public class Water extends Problem {
  ...
  */
  ...
  public void evaluate(Solution solution) throws JMException {         
    ...
    f[1] = 3000.0 * x[0] ;
    // Third function
    f[2] = 305700.0 * 2289.0 * x[1] / Math.pow(0.06*2289, 0.65) ;
    // Fourth function
    f[3] = 250.0 * 2289.0 * Math.exp(-39.75*x[1]+9.9*x[2]+2.74) ;
    // Third function
  ...
  public void evaluateConstraints(Solution solution) throws JMException {
    ...
    constraint[1] = 1.0 - (0.000306/(x[0]*x[1])+1.082*x[2]-0.0986)              ;
    constraint[2] = 1.0 - (12.307/(x[0]*x[1]) + 49408.24*x[2]+4051.02)/50000.0  ;
    constraint[3] = 1.0 - (2.098/(x[0]*x[1])+8046.33*x[2]-696.71)/16000.0;      ;
    constraint[4] = 1.0 - (2.138/(x[0]*x[1])+7883.39*x[2]-705.04)/10000.0       ;
    constraint[5] = 1.0 - (0.417*x[0]*x[1] + 1721.26*x[2]-136.54)/2000/0        ;
    constraint[6] = 1.0 - (0.164/(x[0]*x[1])+631.13*x[2]-54.48)/550.0           ;
