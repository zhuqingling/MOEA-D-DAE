 ...
 */
public class DC2_DTLZ3 extends Problem{
  
 /**
  * Creates a default C1_DTLZ3 problem (12 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public DC2_DTLZ3(String solutionType) throws ClassNotFoundException {
  ...
  */      
	public void evaluate(Solution solution) throws JMException {
		...
		if (numberOfObjectives_ == 3)
			...
			radius = 12.5;
		else if (numberOfObjectives_ == 10)
			radius = 15.0;
		else
			radius = 15.0;
...
//			sum += f[i] * f[i];
		double a=3.0;
		double b=0.9;
		constraints[0] = Math.cos(a*Math.PI*g)-b;//(sum - 16.0) * (sum - 25);
		constraints[1] = Math.exp(-1.0*g)-b;//64 - sum;
		double total = 0.0;
		int number = 0;
