 ...
 */
public class DC1_DTLZ3 extends Problem{
  
 /**
  * Creates a default C1_DTLZ3 problem (12 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public DC1_DTLZ3(String solutionType) throws ClassNotFoundException {
...
//			solution.setOverallConstraintViolation(0.0);
		double a=3.0;
	    double b=0.5;
	    double constraint=Math.cos(a*Math.PI*x[0])-b;
	    if (constraint < 0.0) {
