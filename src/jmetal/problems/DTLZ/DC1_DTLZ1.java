 ...
 */
public class DC1_DTLZ1 extends Problem {   
 /** 
  * Creates a default C1_DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public DC1_DTLZ1(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public DC1_DTLZ1(String solutionType, Integer numberOfVariables, 
  		         Integer numberOfObjectives) throws ClassNotFoundException {
    numberOfVariables_   = numberOfVariables.intValue();
    numberOfObjectives_  = numberOfObjectives.intValue();
    numberOfConstraints_ = 1;
    problemName_         = "DC1_DTLZ1";
...
//	    	sum += f[i];
//	    constraint = 1.0 - f[numberOfObjectives_ - 1] / 0.6 - sum / 0.5;
	    double a=3.0;
	    double b=0.5;
	    constraint=Math.cos(a*Math.PI*x[0])-b;
	    if (constraint < 0.0) {
