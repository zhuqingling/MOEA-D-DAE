...
/**
 * Class representing problem LIRCMOP1
 */
public class LIRCMOP1 extends Problem {
	/**
	 * Creates an LIRCMOP1 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LIRCMOP1(String solutionType) throws ClassNotFoundException {
		this(solutionType, 30, 2);
	} // LIRCMOP1

	/**
	 * Creates an LIRCMOP1 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LIRCMOP1(String solutionType, Integer numberOfVariables,
                    Integer numberOfObjectives) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables.intValue();
		numberOfObjectives_ = numberOfObjectives.intValue();
		numberOfConstraints_ = 2;
		problemName_ = "LIRCMOP1";
