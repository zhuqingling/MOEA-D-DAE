...
/**
 * Class representing problem LIRCMOP11
 */
public class LIRCMOP11 extends Problem {
	/**
	 * Creates an LIRCMOP11 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LIRCMOP11(String solutionType) throws ClassNotFoundException {
		this(solutionType, 30, 2);
	} // LIRCMOP11

	/**
	 * Creates an LIRCMOP11 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LIRCMOP11(String solutionType, Integer numberOfVariables,
					 Integer numberOfObjectives) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables.intValue();
		numberOfObjectives_ = numberOfObjectives.intValue();
		numberOfConstraints_ = 2;
		problemName_ = "LIRCMOP11";
	...
	public void evaluate(Solution solution) throws JMException {
		...
		f[1] = (1.0 - Math.sqrt(x[0])) * (10 * sum2 + 1) * (1 + gx);
	...
	public void evaluateConstraints(Solution solution) throws JMException {
		...
		constraint[0] = f0 * Math.sin(theta) + f1 * Math.cos(theta) - Math.sin(N * Math.PI * (f0 * Math.cos(theta) - f1 * Math.sin(theta))) -2.1;
