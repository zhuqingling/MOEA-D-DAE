...
/**
 * Class representing problem LIRCMOP10
 */
public class LIRCMOP10 extends Problem {
	/**
	 * Creates an LIRCMOP10 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LIRCMOP10(String solutionType) throws ClassNotFoundException {
		this(solutionType, 30, 2);
	} // LIRCMOP10

	/**
	 * Creates an LIRCMOP10 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public LIRCMOP10(String solutionType, Integer numberOfVariables,
                     Integer numberOfObjectives) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables.intValue();
		numberOfObjectives_ = numberOfObjectives.intValue();
		numberOfConstraints_ = 2;
		problemName_ = "LIRCMOP10";
	...
	public void evaluateConstraints(Solution solution) throws JMException {
		...
		constraint[0] = f0 * Math.sin(theta) + f1 * Math.cos(theta) - Math.sin(N * Math.PI * (f0 * Math.cos(theta) - f1 * Math.sin(theta))) -1;
