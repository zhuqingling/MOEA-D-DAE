...
/**
 * Class representing problem CTP3
 */
public class CTP3 extends Problem {
    /**
     * Creates an  CTP3 problem (10 variables and 2 objectives)
     *
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public CTP3(String solutionType) throws ClassNotFoundException {
        this(solutionType, 4, 2);
    } // CTP3

    /**
     * Creates an CTP3 problem instance
     *
     * @param numberOfVariables  Number of variables
     * @param numberOfObjectives Number of objective functions
     * @param solutionType       The solution type must "Real" or "BinaryReal".
     */
    public CTP3(String solutionType,
    ...
    public void evaluateConstraints(Solution solution) throws JMException {
        ...
        double theta = -0.2 * Math.PI, a = 0.1, b = 10.0, c = 1.0, d = 0.5, e = 1.0;
