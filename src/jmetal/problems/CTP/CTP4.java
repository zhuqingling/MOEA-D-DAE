...
/**
 * Class representing problem CTP4
 */
public class CTP4 extends Problem {
    /**
     * Creates an  CTP4 problem (10 variables and 2 objectives)
     *
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public CTP4(String solutionType) throws ClassNotFoundException {
        this(solutionType, 4, 2);
    } // CTP4

    /**
     * Creates an CTP4 problem instance
     *
     * @param numberOfVariables  Number of variables
     * @param numberOfObjectives Number of objective functions
     * @param solutionType       The solution type must "Real" or "BinaryReal".
     */
    public CTP4(String solutionType,
    ...
    public void evaluateConstraints(Solution solution) throws JMException {
        ...
        double theta = -0.2 * Math.PI, a = 0.75, b = 10, c = 1, d = 0.5, e = 1;
