...
/**
 * Class representing problem CTP7
 */
public class CTP7 extends Problem {
    /**
     * Creates an  CTP7 problem (10 variables and 2 objectives)
     *
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public CTP7(String solutionType) throws ClassNotFoundException {
        this(solutionType, 4, 2);
    } // CTP7

    /**
     * Creates an CTP7 problem instance
     *
     * @param numberOfVariables  Number of variables
     * @param numberOfObjectives Number of objective functions
     * @param solutionType       The solution type must "Real" or "BinaryReal".
     */
    public CTP7(String solutionType,
    ...
    public void evaluateConstraints(Solution solution) throws JMException {
        ...
        double theta = -0.05 * Math.PI, a = 40, b = 5, c = 1, d = 6, e = 0;
