...
/**
 * Class representing problem CTP2
 */
public class CTP2 extends Problem {
    /**
     * Creates an  CTP2 problem (10 variables and 2 objectives)
     *
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public CTP2(String solutionType) throws ClassNotFoundException {
        this(solutionType, 4, 2);
    } // CTP2

    /**
     * Creates an CTP2 problem instance
     *
     * @param numberOfVariables  Number of variables
     * @param numberOfObjectives Number of objective functions
     * @param solutionType       The solution type must "Real" or "BinaryReal".
     */
    public CTP2(String solutionType,
    ...
    public void evaluateConstraints(Solution solution) throws JMException {
        double theta = -0.2 * Math.PI, a = 0.2, b = 10.0, c = 1.0, d = 6.0, e = 1.0;
