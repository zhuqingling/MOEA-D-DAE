...
public class Solution implements Serializable {  
  ...
  private final double [] normalized_objective_ ;
  private final double [] pseudo_objective_ ;
  /**
  ...
  private double[] info_;  // add by ql.zhu, refer to "MOEAsR"
  ...
  public Solution() {        
    ...
    variable_                     = null ;
    objective_                    = null ;
    pseudo_objective_ = null;
    normalized_objective_ = null;
    constraint_                   = null ;
  ...
  public Solution(int numberOfObjectives) {
    ...
    pseudo_objective_   = new double[numberOfObjectives];
    normalized_objective_ = new double[numberOfObjectives];
    info_ = new double[3];
    for(int i = 0; i< info_.length; i++){
    	info_[i] = -1;
    }
  ...
  public Solution(Problem problem) throws ClassNotFoundException{
    ...
    pseudo_objective_   = new double[numberOfObjectives_] ;
    normalized_objective_ = new double[numberOfObjectives_] ;
  ...
  public void setNormalizedObjective(int i, double value) {
    normalized_objective_[i] = value;
  } // setObjective
  public void setPseudoObjective(int i, double value) {
    pseudo_objective_[i] = value;
  } // setObjective
  /**
  ...
  public double getNormalizedObjective(int i) {
    return normalized_objective_[i];
  } // getObjective
  public double getPseudoObjective(int i) {
	    return pseudo_objective_[i];
	  } // getObjective
