...
public class SolutionSet implements Serializable {
  ...
  private int int_temp = Integer.MAX_VALUE; 
  /**
   * Constructor.
  ...
  */
  ...
  public double getmaxsumobj()
  {
	  double maxsumobj = 0.0;
	  for (Solution aSolutionsList_ : solutionsList_) 
	  {
		  if(maxsumobj<aSolutionsList_.getSumobjvalue())
			  maxsumobj = aSolutionsList_.getSumobjvalue();
	  }
	  return maxsumobj ;
  }
  /**
