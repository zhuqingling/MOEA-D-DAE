 ...
 */
public class PseudoObjectiveComparator implements Comparator {
   ...
   */
  public PseudoObjectiveComparator(int nObj) {
    this.nObj = nObj;
    ascendingOrder_ = true;
  } // ObjectiveComparator

  public PseudoObjectiveComparator(int nObj, boolean descendingOrder) {
    this.nObj = nObj;
    if (descendingOrder)
  ...
  public int compare(Object o1, Object o2) {
    ...
    double objetive1 = ((Solution) o1).getPseudoObjective(this.nObj);
    double objetive2 = ((Solution) o2).getPseudoObjective(this.nObj);
    if (ascendingOrder_) {
